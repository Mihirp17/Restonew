    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="menu" className="w-full">
        ...
        <TabsContent value="trends" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>F&B Growth Trends</CardTitle>
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={400}>
                <LineChart data={menuAnalytics?.topSelling}>
                  ...
                  <Tooltip />
                  <Line yAxisId="left" type="monotone" dataKey="count" stroke="#0088FE" name="Orders" />
                  <Line yAxisId="right" type="monotone" dataKey="revenue" stroke="#FF6B6B" name="Revenue" />
                </LineChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
